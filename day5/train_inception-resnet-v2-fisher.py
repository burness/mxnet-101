...
parser.add_argument('--model-prefix', type=str, default="fishers",
                    help='the prefix of the model to load')
parser.add_argument('--save-model-prefix', type=str, default="fishers",
...
parser.add_argument('--log-file', type=str, default='fishers.log', help='the name of the log name')
parser.add_argument('--log-dir', type=str, default='./fishers_log/', help='the folder name of the log')
...
def _download(data_dir):
    ...
    if (not os.path.exists('train.rec')) or \
       (not os.path.exists('test.rec')) :
        ...
        zf.close()
        os.remove(zippath)
        for f in glob.glob(os.path.join(dirname, "17flowers", "*")):
