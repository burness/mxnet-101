...
def fit(args, network, data_loader, batch_end_callback=None):
    ...
    checkpoint = None if save_model_prefix is None else mx.callback.do_checkpoint(save_model_prefix, 20)
    ...
    #batch_end_callback.append(mx.callback.log_train_metric(10))
